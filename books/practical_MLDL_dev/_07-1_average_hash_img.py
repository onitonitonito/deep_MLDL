...
if __name__ == '__main__':
    fname = (ROOT, "_statics", "image", "category_101objects", "image_0014-convoluted.jpg")
    print_binary_mean(*fname, size=31)

    fname = (ROOT, "_statics", "image", "category_101objects", "image_0014-reformed.jpg")
    print_binary_mean(*fname, size=31)

    fname = (ROOT, "_statics", "image", "category_101objects", "image_0014.jpg")
    print_binary_mean(*fname, size=31)

    fname = (ROOT, "_statics", "image", "gyudon", "202000499thumb.jpg")
    print_binary_mean(*fname, size=31)
