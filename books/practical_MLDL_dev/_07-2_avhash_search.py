""" p.346 ... average_hash() 를 이용하여 이미지 유사성을 검색함.
"""
import os
import sys
import re
...
search_dir = os.path.join(ROOT, "_statics", "image", "category_101objects")
cache_dir = os.path.join(ROOT, "_statics", "image", "cache_avhash")

if not os.path.exists(cache_dir):
    os.makedirs(cache_dir)

# 이미지 데이터를 AvHash로 변환하기 .. 기본=[31x31]  ...  (*1)
